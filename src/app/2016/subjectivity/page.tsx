...
const mockCandidates: string[] = ["Trump", "Clinton"];
...
const mockSubjectivityTrend: SubjectivityTrendEntry[] = [
  { time: 1, Trump: 0.7, Clinton: 0.4 },
  { time: 2, Trump: 0.5, Clinton: 0.6 },
  { time: 3, Trump: 0.6, Clinton: 0.3 },
  { time: 4, Trump: 0.4, Clinton: 0.5 },
];
